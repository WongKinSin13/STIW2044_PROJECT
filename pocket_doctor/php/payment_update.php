...
$signed= hash_hmac('sha256', $signing, 'S-ZkeofyLscy4x2LJUM2udqQ');
if ($signed === $data['x_signature']) {
    ...
    if ($paidstatus == "Success"){ //payment success
       ...
       $conn->query($sqlinsert);
        ...
        echo '<br><br><body><div><h2><br><br><center>Payment Receipt</center></h1><table border=1 width=80% align=center><tr><td>Order ID</td><td>'.$orderid.'</td></tr><tr><td>Receipt ID</td><td>'.$receiptid.'</td></tr><tr><td>Email to </td><td>'.$userid. ' </td></tr><td>Amount </td><td>RM '.$amount.'</td></tr><tr><td>Payment Status </td><td>'.$paidstatus.'</td></tr><tr><td>Date </td><td>'.date("d/m/Y").'</td></tr><tr><td>Time </td><td>'.date("h:i a").'</td></tr></table><br><p><center>Press back button to return to PocketDoctor™</center></p></div></body>';
